...
def test_config(root: CiscoCT) -> None:
    config = dedent(
        """
        service timestamps debug datetime msec
        !
...
def test_patch(root: CiscoCT) -> None:
    patch = dedent(
        """
        service timestamps debug datetime msec
        service timestamps log datetime msec
...
def test_to_dict(root: CiscoCT) -> None:
    dst = {
        "line": "",
        "tags": [],
        "children": {
            ...
            "service call-home": {"line": "service call-home", "tags": [], "children": {}},
            "platform qfp utilization monitor load 80": {
            ...
            "platform console serial": {"line": "platform console serial", "tags": [], "children": {}},
            "boot-start-marker": {"line": "boot-start-marker", "tags": [], "children": {}},
            "boot-end-marker": {"line": "boot-end-marker", "tags": [], "children": {}},
            "vrf definition MGMT": {
                "line": "vrf definition MGMT",
                "tags": ["vrf", "MGMT"],
                "children": {
                    "address-family ipv4": {"line": "address-family ipv4", "tags": ["vrf", "MGMT"], "children": {}}
                },
            },
            "aaa new-model": {"line": "aaa new-model", "tags": ["mgmt", "aaa"], "children": {}},
            "aaa authentication login default local": {
            ...
            "spanning-tree extend system-id": {"line": "spanning-tree extend system-id", "tags": [], "children": {}},
            "username admin privilege 15 secret 9 admin-secret-key": {
            ...
            "interface GigabitEthernet1": {
                ...
                "children": {
                    ...
                    "no mop sysid": {"line": "no mop sysid", "tags": ["interface", "GigabitEthernet1"], "children": {}},
                    "service-policy output PL_NAME_1": {
            ...
            "class-map match-all CM_NAME_1": {
                ...
                "tags": ["qos", "CM_NAME_1"],
                "children": {
                    "match  dscp af41": {"line": "match  dscp af41", "tags": ["qos", "CM_NAME_1"], "children": {}}
                },
            },
            "class-map match-all CM_NAME_2": {
                ...
                "tags": ["qos", "CM_NAME_2"],
                "children": {
                    "match  dscp ef": {"line": "match  dscp ef", "tags": ["qos", "CM_NAME_2"], "children": {}}
                },
            },
            "policy-map PL_NAME_1": {
                ...
                "children": {
                    ...
                    "class CM_NAME_5": {
                        ...
                        "children": {
                            ...
                            "fair-queue": {"line": "fair-queue", "tags": ["qos", "PL_NAME_1"], "children": {}},
                        },
                    },
                    "class CM_NAME_6": {
            ...
            "ip ssh version 2": {"line": "ip ssh version 2", "tags": ["mgmt", "ssh"], "children": {}},
            "ip access-list extended ACL_NAME_1": {
            ...
            "line con 0": {
                "line": "line con 0",
                "tags": [],
                "children": {"stopbits 1": {"line": "stopbits 1", "tags": [], "children": {}}},
            },
            "line vty 0 4": {
                "line": "line vty 0 4",
                "tags": [],
                "children": {"transport input all": {"line": "transport input all", "tags": [], "children": {}}},
            },
            "line vty 5 15": {
                "line": "line vty 5 15",
                "tags": [],
...
def test_from_dict(root: CiscoCT) -> None:
    src = {
        "line": "",
        "tags": [],
        "children": {
...
def test_masked_config(root: CiscoCT) -> None:
...
def test_masked_patch(root: CiscoCT) -> None:
    masked_patch = dedent(
        f"""
        service timestamps debug datetime msec
        service timestamps log datetime msec
...
def test_searcher(root: CiscoCT) -> None:
    qos_config = dedent(
        """
        interface GigabitEthernet1
         service-policy output PL_NAME_1
